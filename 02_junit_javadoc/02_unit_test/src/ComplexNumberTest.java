...
public class ComplexNumberTest {
    ...
    public void testConjugate() {
        ...
        assertEquals(new ComplexNumber(3, -5), d.conjugate());
        assertEquals(new ComplexNumber(-2, 4), e.conjugate());
    ...
    public void testBetrag() {
        ...
        ComplexNumber e = new ComplexNumber(0, 3);
    ...
    public void testPotenz() {
        ...
        assertEquals(new ComplexNumber(1, 0), d.power(0));
        assertEquals(new ComplexNumber(2, -4), d.power(1));
        assertEquals(new ComplexNumber(-12, -16), d.power(2));
        assertEquals(new ComplexNumber(-88, 16), d.power(3));
        assertEquals(new ComplexNumber(7488, -2816), d.power(6));
    }
}
